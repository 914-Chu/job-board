...
const Main = () => {
  ...
  const filter = (
    ...
    if (!Object.values(ratingsFilter).every((o) => o === false)) {
      ...
      results = results.filter((job) => {
        return toBeIncluded.includes(
          Math.round(job.ratingTotals[0] / job.numberReviews)
        );
      });
    }
      ...
      <div className="main-section-container">
        <section className="main-filter-section">
          ...
          <Form.Group as={Row} controlId="job-average-rating">
            <Form.Label>Average Ratings</Form.Label>
            <Form.Check type="checkbox">
              ...
              />
              <Form.Check.Label>{getNStars(1)}</Form.Check.Label>
            </Form.Check>
            <Form.Check type="checkbox">
              <Form.Check.Input
                type="checkbox"
                ...
                onChange={handleAvgRatingsChange}
              />
              <Form.Check.Label>{getNStars(2)}</Form.Check.Label>
            </Form.Check>
            <Form.Check type="checkbox">
              <Form.Check.Input
                type="checkbox"
                ...
                onChange={handleAvgRatingsChange}
              />
              <Form.Check.Label>{getNStars(3)}</Form.Check.Label>
            </Form.Check>
            <Form.Check type="checkbox">
              <Form.Check.Input
                type="checkbox"
                ...
                onChange={handleAvgRatingsChange}
              />
              <Form.Check.Label>{getNStars(4)}</Form.Check.Label>
            </Form.Check>
            <Form.Check type="checkbox">
              <Form.Check.Input
                type="checkbox"
                ...
                onChange={handleAvgRatingsChange}
              />
              <Form.Check.Label>{getNStars(5)}</Form.Check.Label>
            </Form.Check>
          </Form.Group>

          <Form.Group as={Row} controlId="job-pay-range">
            <Form.Label>Min Hourly Pay</Form.Label>
            <Form.Group as={Row}>
              <Col xs="12">
                <InputGroup>
        ...
        <section className="main-jobs-section">
          {getAllJobCards.length > 0 ? (
            ...
            <div className="empty-results">
              <h2>Nothing found!</h2>
              <img src={emptyResImg} height="300px" alt="empty-results-img" />
            </div>
          )}
        </section>
      </div>
